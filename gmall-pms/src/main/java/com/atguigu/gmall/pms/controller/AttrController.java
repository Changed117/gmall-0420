...
public class AttrController {
    ...
    @ApiOperation("分页查询")
    public ResponseVo<List<AttrEntity>> queryArraysByGid(@PathVariable("gid")Long gid){

        List<AttrEntity> attrEntities = this.attrService.list(new QueryWrapper<AttrEntity>()
                .eq("group_id", gid));
